...
class GameTestBase extends TestBase {
	...
	function setUp(): void {
		...
		$this->db->execute("INSERT INTO point (point_id, game_id, name) VALUES (4, 1, 'Dvoračky')");
		...
		$this->db->execute("INSERT INTO step (from_point_id, to_point_id) VALUES (1, 11), (1, 12), (11, 2), (12, 3), (2, 13), (3, 13), (13, 4), (4, 14), (14, 5)");
