...
class TeamCrudTest extends CrudTestBase {
	...
	function testCreate() {
		...
		$this->assertEquals([
			["game_id" => 1, "team_id" => 1, "name" => "Parta Nic", "pswd" => "PRAK", "phone" => null, "email" => null, "members" => [], "accomodation" => true, "paid" => false, "tshirt" => 0, "remarks" => null, "additional" => null, "points" => 0, "fee" => 0],
	...
	function testCreateWithGameId() {
		...
		$_SESSION["game_id"] = 2;
		$this->assertEquals([
			["game_id" => 2, "team_id" => $team["team_id"], "name" => "Pípy z Lípy", "pswd" => "ZIDLE", "phone" => null, "email" => null, "members" => [], "accomodation" => false, "paid" => false, "tshirt" => 0, "remarks" => null, "additional" => null, "points" => 0, "fee" => 0]
		], $this->list());
	}
	...
	function testUpdate() {
		...
		$this->update($team);
		$this->assertEquals(array(
			["game_id" => 1, "team_id" => 1, "name" => "Pípy z Lípy", "pswd" => "PRAK", "phone" => null, "email" => null, "members" => [], "accomodation" => true, "paid" => false, "tshirt" => 0, "remarks" => null, "additional" => null, "points" => 0, "fee" => 0]
		), $this->list());
	}
