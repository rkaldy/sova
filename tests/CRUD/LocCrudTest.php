...
class LocCrudTest extends CrudTestBase {
	...
	function testCreate() {
		...
		$this->assertEquals([
			["point_id" => 1, "name" => "1a", "description" => null, "solved_cipher_count" => null, "end_time" => null, "coord_lat" => null, "coord_lon" => null, "code" => "PRALINKA", "prev" => [], "next" => []],
			["point_id" => 2, "name" => "1b", "description" => null, "solved_cipher_count" => null, "end_time" => null, "coord_lat" => null, "coord_lon" => null, "code" => "KYBL", "prev" => [], "next" => []],
			["point_id" => $loc["point_id"], "name" => "Turniket", "description" => null, "solved_cipher_count" => null, "end_time" => null, "coord_lat" => null, "coord_lon" => null, "code" => "OVCE", "prev" => [], "next" => []]
		], $this->list());
	...
	function testUpdate() {
		...
		$this->assertEquals([
			["point_id" => 1, "name" => "1a", "description" => null, "solved_cipher_count" => null, "end_time" => null, "coord_lat" => null, "coord_lon" => null, "code" => "PRALINKA", "prev" => [], "next" => []],
			["point_id" => 2, "name" => "Turniket", "description" => null, "solved_cipher_count" => null, "end_time" => null, "coord_lat" => null, "coord_lon" => null, "code" => "VEDRO", "prev" => [], "next" => []]
		], $this->list());
	}
