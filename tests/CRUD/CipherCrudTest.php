...
class CipherCrudTest extends CrudTestBase {
	...
	function testCreate() {
		...
		$this->assertEquals([
			["point_id" => 5, "name" => "S1", "name_int" => "Morseovka", "activity" => false, "hint" => null, "code" => "ZABRADLI", "prev" => [1], "next" => [2], "points" => 0],
			["point_id" => 6, "name" => "S2", "name_int" => "Braille", "activity" => false, "hint" => null, "code" => "KOBLIHA", "prev" => [1], "next" => [3], "points" => 0],
			["point_id" => $cipher1["point_id"], "name" => "S3", "name_int" => "semafor", "activity" => false, "hint" => null, "code" => "JAVOR", "prev" => [2], "next" => [3, 4], "points" => 0],
			["point_id" => $cipher2["point_id"], "name" => "S4", "name_int" => "nahradni", "activity" => false, "hint" => null, "code" => "SOLITER", "prev" => [], "next" => [], "points" => 1]
		], $this->list());
	...
	function testUpdate() {
		...
		$this->assertEquals([
			["point_id" => 5, "name" => "S1", "name_int" => "Morseovka", "activity" => false, "hint" => null, "code" => "ZABRADLI", "prev" => [1], "next" => [2], "points" => 0],
			["point_id" => 6, "name" => "S3", "name_int" => "Caesar", "activity" => false, "hint" => null, "code" => "RUBIKON", "prev" => [1, 2], "next" => [3, 4], "points" => 2]
		], $this->list());
		$this->assertEquals(6, $this->db->equery("SELECT COUNT(*) FROM point"));
		$this->assertEquals(2, $this->db->equery("SELECT COUNT(*) FROM cipher"));
		$this->assertEquals(2, $this->db->equery("SELECT COUNT(*) FROM code"));
