...
use DateTimeZone;
use Sova\TestBase;
use Sova\Controller\REST\MessageController;
...
/*	function testREST() {
		...
		$resp = (new MessageController())->list(["page" => 1, "pageSize" => 20]);
		$this->assertEquals(2, $resp["itemsCount"]);
		$this->assertEquals([
			["name" => "Parta Nic", "direction" => Message::TO_TEAM, "direction_str" => "out", "text" => "Nazdar"],
			["name" => "Parta Nic", "direction" => Message::FROM_TEAM, "direction_str" => "in", "text" => "Ahoj"]
