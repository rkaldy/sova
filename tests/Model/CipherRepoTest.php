...
class CipherRepoTest extends TestBase {
	...
	function testCreate() {
		$newCipher1 = $this->repo->create(array("name" => "S3", "name_int" => "semafor", "code" => "javor", "prev" => array(2), "next" => array(4, 3)));
		$newCipher2 = $this->repo->create(array("name" => "S4", "name_int" => "nahradni", "code" => "soliter", "prev" => array()));
		$this->assertEquals(array(
			array("point_id" => 5, "game_id" => 1, "sort_id" => null, "name" => "S1", "name_int" => "Morseovka", "solution_timeout" => null, "hint" => null, "hint_timeout" => null, "code" => "ZABRADLI", "prev" => array(1), "next" => array(2)),
			array("point_id" => 6, "game_id" => 1, "sort_id" => null, "name" => "S2", "name_int" => "Braille", "solution_timeout" => null, "hint" => null, "hint_timeout" => null, "code" => "KOBLIHA", "prev" => array(1), "next" => array(3)),
			array("point_id" => $newCipher1["point_id"], "game_id" => 1, "sort_id" => null, "name" => "S3", "name_int" => "semafor", "solution_timeout" => null, "hint" => null, "hint_timeout" => null, "code" => "JAVOR", "prev" => array(2), "next" => array(3, 4)),
			array("point_id" => $newCipher2["point_id"], "game_id" => 1, "sort_id" => null, "name" => "S4", "name_int" => "nahradni", "solution_timeout" => null, "hint" => null, "hint_timeout" => null, "code" => "SOLITER", "prev" => array(), "next" => array())
		), $this->repo->list());
	...
	function testCreateDuplicateCode() {
		try {
			$newCipher = $this->repo->create(array("name" => "S3", "code" => "zabradli"));
	...
	function testUpdate() {
		$this->repo->update(array("point_id" => 6, "name" => "S3", "name_int" => "Caesar", "code" => "RUBIKON", "prev" => array(1, 2), "next" => array(3, 4)));
		$this->assertEquals(array(
			array("point_id" => 5, "game_id" => 1, "sort_id" => null, "name" => "S1", "name_int" => "Morseovka", "solution_timeout" => null, "hint" => null, "hint_timeout" => null, "code" => "ZABRADLI", "prev" => array(1), "next" => array(2)),
			array("point_id" => 6, "game_id" => 1, "sort_id" => null, "name" => "S3", "name_int" => "Caesar", "solution_timeout" => null, "hint" => null, "hint_timeout" => null, "code" => "RUBIKON", "prev" => array(1, 2), "next" => array(3, 4))
		), $this->repo->list());
		$this->assertEquals(6, $this->db->equery("SELECT COUNT(*) FROM point"));
		$this->assertEquals(2, $this->db->equery("SELECT COUNT(*) FROM cipher"));
		$this->assertEquals(2, $this->db->equery("SELECT COUNT(*) FROM code"));
	...
	function testDelete() {
		$this->repo->delete(array("point_id" => 6));
		$this->assertEquals(array(
			array("point_id" => 5, "game_id" => 1, "sort_id" => null, "name" => "S1", "name_int" => "Morseovka", "solution_timeout" => null, "hint" => null, "hint_timeout" => null, "code" => "ZABRADLI", "prev" => array(1), "next" => array(2))
		), $this->repo->list());
